import { AVATAR_JOINT_COUNT, type GaussianMotionAsset } from "./AvatarAssets.js";

export type AvatarPreviewPoseId = "relaxed" | "akimbo" | "victory" | "rest";

export interface AvatarPreviewPoseOption {
  id: AvatarPreviewPoseId;
  label: string;
  code: string;
  description: string;
}

export const AVATAR_PREVIEW_POSES: readonly AvatarPreviewPoseOption[] = [
...
const POSE_ROTATIONS: Record<AvatarPreviewPoseId, readonly JointRotation[]> = {
  relaxed: [
...
export function createAvatarPreviewPose(id: AvatarPreviewPoseId): GaussianMotionAsset {
