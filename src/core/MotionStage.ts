...
import type { GaussianAvatar } from "./avatar/GaussianAvatar.js";
...
export class MotionStage {
  ...
  private avatarHandle: GaussianAvatar | null = null;
  private lastAvatarFrame = -1;
  ...
  setAvatar(avatar: GaussianAvatar | null): void {
    if (this.webglFailed) return;
    if (this.avatarHandle) {
  ...
  private updateAvatar(frame: RuntimeFrame | null): void {
